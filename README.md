...
This is a sample template for dynamoLambda - Below is a brief explanation of what we have generated for you:

```bash
.
├── Makefile                    <-- Make to automate build
├── README.md                   <-- This instructions file
├── read-dynamodb                 <-- Source code for a lambda function
