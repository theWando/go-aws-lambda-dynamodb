module github.com/theWando/go-aws-lambda-dynamodb/post-restaurant
...
require (
	...
	github.com/theWando/go-aws-lambda-dynamodb/lambda-lib v0.0.0-20211024185519-e87cce23d2e5
